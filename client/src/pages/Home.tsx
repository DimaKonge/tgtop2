              ...
              <>
                ...
                <div className="relative flex flex-col">
                  ...
                  {placementSlot && selectedLotGroup && (
                    <section aria-disabled={lotSettingsLocked} style={getCommunityCardBackgroundStyle(selectedLotGroup.cardBackgroundPreset ?? listingCardBackgroundPreset)} className={`mt-3 rounded-2xl border border-white/10 bg-[#111720] p-3 shadow-[0_8px_24px_rgba(0,0,0,0.16)] ${lotSettingsLocked ? "opacity-35 grayscale" : ""}`}>
                      <div className="flex items-center justify-between">
                        <span><h2 className="text-[15px] font-semibold tracking-tight text-white">{selectedSlot ? "Текущая ставка за лот" : "Ставка для размещения"}</h2><small className="mt-0.5 block text-[10px] text-slate-500">Место #{placementSlot.slotNumber}</small></span>
