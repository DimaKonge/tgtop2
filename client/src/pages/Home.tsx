...
type TelegramAnalyticsSummary = { notificationsEnabled?: { part?: number; total?: number } };
...
function TelegramAnalyticsChart({ title, graph, range, accent = "#72a8ff", showLatest = true }: { title: string; graph?: TelegramAnalyticsGraph; range: "day" | "month" | "all"; accent?: string; showLatest?: boolean }) {
