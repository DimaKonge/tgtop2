...
export function WalletNftCard({
  ...
  return (
    <article
      onClick={handleClick}
      className="group relative cursor-pointer overflow-hidden rounded-xl border border-white/9 bg-[#111720] p-2.5 transition-colors hover:border-[#3f8cff]/30 hover:bg-[#151d29]"
    >
      ...
      {/* Action button to configure listing */}
      <button
        type="button"
        onClick={(e) => {
          e.stopPropagation();
