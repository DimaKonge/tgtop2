...
CREATE INDEX `ton_withdrawals_user_created_idx` ON `ton_withdrawals` (`userOpenId`,`createdAt`);
CREATE INDEX `ton_withdrawals_destination_created_idx` ON `ton_withdrawals` (`destinationWalletAddress`,`createdAt`);
