...
try {
  ...
  if (!(await hasTable("telegram_stats_targets"))) {
    await connection.query(`CREATE TABLE \`telegram_stats_targets\` (
      \`id\` int AUTO_INCREMENT NOT NULL,
  ...
  if (!(await hasTable("telegram_stats_snapshots"))) {
    await connection.query(`CREATE TABLE \`telegram_stats_snapshots\` (
      \`id\` int AUTO_INCREMENT NOT NULL,
  ...
  if (!(await hasIndex("telegram_stats_snapshots", "telegram_stats_snapshots_target_collected_idx"))) {
    await connection.query("CREATE INDEX `telegram_stats_snapshots_target_collected_idx` ON `telegram_stats_snapshots` (`targetId`, `collectedAt`)");
  }
