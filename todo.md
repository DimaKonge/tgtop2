...
- [ ] Сохранить и показывать исходный анимированный аватар затронутой группы вместо статичного Telegram-кадра.
...
- [ ] Получить исходный MP4 анимированного аватара F_I_N_E_G_O_L_D от владельца и сохранить его в карточках TG TOP.
