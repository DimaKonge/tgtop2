...
- [ ] Синхронизировать текущий проверенный код в DimaKonge/tgtop2 и выкатить его на VPS; отдельно проверить live health/services, не смешивая это с незавершённым checkpoint blocker.
