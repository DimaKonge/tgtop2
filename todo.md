...
- [ ] Исправить блокировку подтверждённого главного администратора в панели «Рабочий аккаунт Telegram»: использовать безопасное server-side owner-право вместо несовпадающего legacy ownerOpenId, сохранив запрет для обычных пользователей и модераторов.
