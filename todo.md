...
- [ ] Показывать в панели свободного лота видимый общий итог: ставка за место, бюджет вознаграждений и сумма к списанию в GRAM.
- [ ] Добавить на ползунок ставки отдельную среднюю ориентирную метку между минимумом и максимумом.
