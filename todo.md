...
- [ ] Проверить новую заявку вывода со статусом «В обработке», безопасно сверить её с сетью без повторной отправки и сократить время до понятного подтверждённого статуса.
