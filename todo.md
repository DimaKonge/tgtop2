...
- [ ] Показывать в карточке Top только информацию о группе и ставку для перебития, оставляя прогноз только для неразмещённых групп.
- [ ] Перенести подробную панель кампании вознаграждений в карточку своей группы в рабочем пространстве.
- [ ] Показывать в рабочем пространстве подтверждённые Telegram-показатели: для каналов — подписчиков, вступивших, отписавшихся и просмотры последнего поста; для чатов — участников, вступивших, приглашённых по ссылке и отписавшихся.
- [ ] Показывать в рабочем пространстве активность за сегодня: посты для каналов и сообщения для чатов, с честным состоянием отсутствия доступа.
