...
- [ ] Добавить в рабочее пространство компактные вкладки «Сообщества», «Боты» и «NFT»; в NFT показать реальные активы подключённого TON-кошелька без включения платежей, переводов или аренды и дать фильтры «Гифты», «Юзернеймы», «Анон-номера», «Домены» и «Другие NFT».
