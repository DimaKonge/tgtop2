...
- [ ] Синхронизировать проверенную версию интерфейса с текущим продакшен-доменом Telegram Mini App у @TG_TOPBOT без подмены адреса бота тестовой ссылкой Manus.
...
- [ ] Удалить временный ключ обслуживания из служебного пользователя, восстановить проверенный доступ к VPS и обновить текущий Mini App TG TOP на `tgtop.xyz` без смены URL бота.
