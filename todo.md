...
- [ ] Скрыть строку поиска ТОПа за компактной кнопкой с раскрытием поиска по нажатию.
- [ ] Убрать NFT из переключателя «Все / Каналы / Чаты» и добавить самостоятельные верхние разделы «Сообщества», «NFT» и «Боты».
- [ ] Перенести географию и тематические рубрики из текущей строки фильтров в более компактное отдельное место.
