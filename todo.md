...
- [ ] Добавить пользователю выбор визуального стиля TG TOP Original / Telegram Clean и независимый режим темы System / Dark / Light с сохранением настроек.
- [ ] Добавить переключаемую Gift-палитру цветов в стиле Telegram Gifts, применённую к фирменной сетке TG TOP.
- [ ] Добавить полноценный picker оттенков для TG TOP: тёмные, синие, фиолетовые, красные, золотые, зелёные и бирюзовые варианты с активным состоянием.
