...
- [ ] Добавить anti-Sybil вход для bot-added: принимать новую площадку в каталог только при подтверждённом одноразовом onboarding intent того же Telegram-владельца; неподтверждённые массовые добавления отбрасывать без карточек, бонусов, рейтинга, публикаций и неограниченного хранения событий.
