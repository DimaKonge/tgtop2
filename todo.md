...
- [ ] Диагностировать и исправить отказ Telegram при подтверждении корректного свежего кода рабочего аккаунта: проверить server-side session/code-hash lifecycle, нормализацию ответа библиотеки и безопасную классификацию ошибки без журналирования кода или 2FA.
